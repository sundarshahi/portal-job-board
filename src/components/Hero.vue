...
<template>
    <div class="w-full h-[80vh] flex items-center md:justify-between justify-center md:px-24 px-5 bg-coer bg-no-repeat bg-center relative"
        ...
        <div class="flex flex-col gap-8 z-50">
            ...
            <button class="text-white rounded-full bg-indigo-500 w-40 p-3">
                Find Jobs Now
            </button>
        </div>
        <div class="w-full h-[calc(80vh-60px)] z-10 bg-indigo-900 opacity-60 absolute top-[60px] left-0"></div>
    </div>
</template>
